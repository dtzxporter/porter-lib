...
fn color_mode() -> bool {
    ...
    *MODE.get_or_init(|| {
        ...
        // GetStdHandle will return an invalid handle on error, which is safe to pass to GetConsoleMode.
        unsafe { GetConsoleMode(GetStdHandle(STD_OUTPUT_HANDLE), &mut mode as *mut _) };
