...
/// Size of the vertex buffer for images.
const VERTEX_BUFFER_SIZE: usize = (size_of::<Vector3>() * 6) + (size_of::<Vector2>() * 6);
    ...
    pub fn from_image(
        ...
        let render_pipeline_layout = instance
            ...
            .create_pipeline_layout(&PipelineLayoutDescriptor {
                label: None,
                bind_group_layouts: &[bind_group_layouts, &[Some(&bind_group_layout)]].concat(),
                immediate_size: 0,
            });
        ...
        let mut vertex_buffer: StackVec<u8, VERTEX_BUFFER_SIZE> = StackVec::new();

        vertex_buffer.write_struct(Vector3::new(-1.0, -1.0, 0.0))?;
        vertex_buffer.write_struct(Vector2::new(0.0, 0.0))?;
        vertex_buffer.write_struct(Vector3::new(width, -1.0, 0.0))?;
        vertex_buffer.write_struct(Vector2::new(1.0, 0.0))?;
        vertex_buffer.write_struct(Vector3::new(width, height, 0.0))?;
        vertex_buffer.write_struct(Vector2::new(1.0, 1.0))?;

        vertex_buffer.write_struct(Vector3::new(-1.0, -1.0, 0.0))?;
        vertex_buffer.write_struct(Vector2::new(0.0, 0.0))?;
        vertex_buffer.write_struct(Vector3::new(width, height, 0.0))?;
        vertex_buffer.write_struct(Vector2::new(1.0, 1.0))?;
        vertex_buffer.write_struct(Vector3::new(-1.0, height, 0.0))?;
        vertex_buffer.write_struct(Vector2::new(0.0, 1.0))?;
